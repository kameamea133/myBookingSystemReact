...
import { PopoverGroup, Popover, Disclosure, Dialog, Transition, PopoverButton, PopoverPanel, DialogPanel, DisclosureButton, DisclosurePanel } from "@headlessui/react"
...
function Header() {
  ...
  return (
    <header className='fixed z-20 w-full flex justify-between p-4 items-center bg-transparent'>
        <nav className='mx-auto w-full max-w-[90%] flex items-center justify-between p-6 lg:px-8' aria-label='Global'>
            <div className="flex lg:flex-1 lg:mb-5">
            <Link href='/' className="-m-1.5 p-1 flex items-center">
                ...
                className="w-auto"
                />
                 <span className=" text-xl font-bold text-white">myBooking.com</span>
            </Link>
            </div>
                        ...
                        <div className="p-4">
                            {products.map((item) => (
                                ...
                                <div className="flex h-11 w-11 flex-none items-center justify-center rounded-lg bg-gray-50 group-hover:bg-gray-200">
                                    <item.icon 
                                    className="h-6 w-6 text-[#013B94] gropy-hover:text-blue-600"
                                    />
                                </div>
        ...
        >
            ...
            <DialogPanel className="fixed inset-y-0 z-10 w-full overflow-y-auto bg-[#f07167] px-6 py-6 sm:max-w-sm sm:ring-1 sm:ring-gray-900/10">
            <div className="flex items-center justify-between">
                <a href="#" className="-m-1.5 p-1.5">
                  <span className="sr-only">Booking.com</span>
                  <Image src="/bookingLogo.png" alt="logo" height={120} width={120}/>
                </a>
                ...
                <div className="my-6 divide-y divide-gray-500/10">
                    <div className="space-y-2 py-6">
                        ...
                        >
                            {({ open }) => (
                              <>
                                <DisclosureButton className="flex w-full items-center justify-between rounded-lg py-2 pl-3 pr-3.5 text-base font-semibold leading-7 text-white hover:bg-[#f07167]">
                                    Stays
                                    <ChevronDownIcon 
                                    className={cn(
                                        open ? "rotate-180" : "",
                    ...
                    <div className="py-6">
                        <a
                        href="#"
                        className="-mx-3 block rounded-lg px-3 py-2.5 text-base font-semiblod leading-7 "
                        ></a>
                    </div>
                </div>
            </div>
